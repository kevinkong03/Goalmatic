...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference("Badge.count") do
      post badges_url, params: { badge: { category_id: @badge.category_id, count: @badge.count, description: @badge.description, goal_type: @badge.goal_type, name: @badge.name } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { category_id: @badge.category_id, count: @badge.count, description: @badge.description, goal_type: @badge.goal_type, name: @badge.name } }
